        ...
        <div className="container mx-auto px-4 py-8 flex-grow">
          ...
          <div className="flex justify-center mb-6">
            <button
              ...
              className={`px-6 py-2 mr-2 rounded-lg ${activeCategory === 'repairs' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
            >
              Repairs
            </button>
            <button
              onClick={() => setActiveCategory('installations')}
              className={`px-6 py-2 rounded-lg ${activeCategory === 'installations' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
            >
              Installations
            </button>
          </div>
